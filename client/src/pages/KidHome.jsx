...
const styles = {
  ...
  name: { fontSize: 'var(--font-xl)', fontWeight: 900, textShadow: '0 4px 0px rgba(0,0,0,0.8)', color: '#fff' },
  sub: { fontSize: 'var(--font-base)', color: 'rgba(255,255,255,0.9)', textShadow: '0 2px 4px rgba(0,0,0,0.6)', fontWeight: 800 },
  streakBadge: {
    display: 'flex', alignItems: 'center', gap: 6,
    padding: '10px 24px',
  },
  streakFire: { fontSize: 28, filter: 'drop-shadow(0 0 8px #FF6D00)' },
  streakNum: { fontSize: 32, fontWeight: 900, color: 'var(--accent-orange)', textShadow: '0 3px 0 rgba(0,0,0,0.3)' },
  streakLabel: { fontSize: 14, fontWeight: 800, color: 'var(--text-dark)', textTransform: 'uppercase', letterSpacing: 1 },
  coinBadge: {
    display: 'flex', alignItems: 'center', gap: 6,
  ...
  coinNum: { fontSize: 32, fontWeight: 900, color: 'var(--accent-cyan)', textShadow: '0 3px 0 rgba(0,0,0,0.3)' },
  coinLabel: { fontSize: 14, fontWeight: 800, color: 'var(--text-dark)', textTransform: 'uppercase', letterSpacing: 1 },
  badgesSection: { marginBottom: 32 },
  badgesTitle: { fontSize: 'var(--font-base)', fontWeight: 900, marginBottom: 16, color: 'rgba(255,255,255,0.9)', textShadow: '0 2px 4px rgba(0,0,0,0.6)' },
  badgesRow: { display: 'flex', gap: 16, flexWrap: 'wrap' },
  badge: {
    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6,
    padding: '14px 20px', minWidth: 80,
    background: 'var(--clay-bg-purple)',
    borderRadius: 24,
    boxShadow: '0 8px 16px rgba(0,0,0,0.2), inset 2px 2px 8px #fff, inset -2px -4px 8px rgba(0,0,0,0.1)',
  },
  badgeEmoji: { fontSize: 36, filter: 'drop-shadow(0 4px 6px rgba(0,0,0,0.3))' },
  badgeName: { fontSize: 13, fontWeight: 900, color: 'var(--text-dark)' },
