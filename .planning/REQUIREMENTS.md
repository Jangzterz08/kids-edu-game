...
- [x] **OBS-02**: Parent dashboard enhanced with time-on-app chart, lessons-per-day histogram, and per-module star trends
- [x] **OBS-03**: Teacher dashboard enhanced with class-level performance metrics: average stars per module, completion rates, struggling kids flagged
...
| OBS-02 | Phase 7 — Analytics & Observability | Complete |
| OBS-03 | Phase 7 — Analytics & Observability | Complete |
